...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="{{('public/backend/css/themes.css')}}">
        <!-- END Stylesheets -->
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <header class="navbar navbar-inverse">
                ...
                <!-- Logo -->
                <a href="index.html" class="navbar-brand"><img src="{{('public/backend/img/template/logo.png')}}" alt="logo"></a>
                ...
                <ul id="widgets" class="navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown pull-right dropdown-user">
                        <?php
                            ...
                            if($admin_name)
                            {
                                echo('<span style="color: #eee;">'.$admin_name.'</span>');
                            }
                        ?>
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><img src="{{('public/backend/img/template/avatar.png')}}" alt="avatar"> <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="{{URL::to('/admin-logout')}}"><i class="fa fa-lock"></i> Log out</a>
                            </li>
                        </ul>
                    </li>
                    <!-- END User Menu -->
            ...
            <!-- END Header -->
                ...
                <!-- Footer -->
                <footer>
                    <span id="year-copy"></span> &copy; <strong><a href="http://goo.gl/9QhXQ">Admin </a></strong> - Crafted with <i class="fa fa-heart text-danger"></i> by <strong><a href="http://goo.gl/vNS3I" target="_blank">Ngô Công Lâm</a></strong>
                </footer>
                <!-- END Footer -->
            </div>
            <!-- END Inner Container -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="example-user-tabs-profile">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <img src="{{('public/backend/img/placeholders/image_dark_120x120.png')}}" alt="image" class="img-responsive push">
                                        </div>
                                        <div class="col-md-9">
        ...
        <script>
            $(function () {
                ...
                // Javascript code only for page all category
                ...
                // Javascript code only for page add category
                ...
                */
                ...
                $('#form-validation').validate({
                    ...
                    rules: {
                        ...
                        val_descriptioncategory: {
                            required: true
                        }
                    },
                    messages: {
                        val_namecategory: {
                            required: 'Please enter a categoryname',
                            minlength: 'Your categoryname must consist of at least 2 characters'
                        },
                        val_display: 'Please select!',
                        val_descriptioncategory: 'Please enter a text!'
                    }
                });

                // Javascript code only for page dashboard

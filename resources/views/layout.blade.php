...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{('public/frontend/css/open-iconic-bootstrap.min.css')}}">
        ...
        <link rel="stylesheet" href="{{('public/frontend/css/jquery.timepicker.css')}}">
            ...
            <div class="container">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Ngô Công Lâm</a>
